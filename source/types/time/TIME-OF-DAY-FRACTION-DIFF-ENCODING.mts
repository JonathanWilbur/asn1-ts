...
class TIME_OF_DAY_FRACTION_DIFF_ENCODING {
    /**
     * @summary Determine whether a value is a `TIME-OF-DAY-FRACTION-DIFF-ENCODING`
     * @description
     *
     * Returns `true` if `value` is a `TIME-OF-DAY-FRACTION-DIFF-ENCODING` from this copy or
     ...
     * @return {boolean} `true` if `value` is a `TIME-OF-DAY-FRACTION-DIFF-ENCODING`
     * @static
     * @function
